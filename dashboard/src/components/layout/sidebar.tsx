    ...
    <aside className="flex h-screen w-56 shrink-0 flex-col border-r bg-card/50">
              ...
              {items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={onNavigate}
                    className={cn(
                      'group flex items-center gap-2.5 rounded-md px-3 py-[var(--space-nav-y)] text-[13px] transition-all',
                      active
      ...
      <div className="px-2 py-2">
        <Link
          ...
          onClick={onNavigate}
          className={cn(
            'flex items-center gap-2.5 rounded-md px-3 py-[var(--space-nav-y)] text-[13px] transition-all',
            isActive('/settings')
              ? 'bg-primary/10 text-primary font-medium'
              : 'text-muted-foreground hover:bg-muted/50 hover:text-foreground'
          )}
